...
const App =()=>{
    ...
    const handleUpdateBookmark=(id)=>{
        return (users.find((cur)=>cur._id===id).bookmark?'bi bi-award-fill':'bi bi-award')
    }
                    ...
                    <tbody>
                        {users.map((user) => (
                            <tr key={user._id}>
                                ...
                                <td>
                                <UserFavorite id={user._id} onUpdate={handleUpdateBookmark} 
                                                            onFavotrite={handleClickFavorite} />
                                </td>
                                <td>
                                  <UserDelete id={user._id} onDelete={handleDelete} />
                                </td>
                            </tr>
                        ))}
                    </tbody>
